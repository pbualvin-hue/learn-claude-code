...
## 下次開發主題（使用者 2026-07-17 裁決順序，同日已完成項目 1）
1. ~~其餘 9 個參考頁的「實戰進階」第二批~~——**已完成（2026-07-17）**：深淺度評估後挑 5 頁機制類補齊（slash-commands/built-in-tools/claude-md-memory/background-tasks-scheduling/claude-directory），what-is-claude-code/install/conversation-basics/faq 4 頁判定 intro 類維持不動。細節見 DECISIONS 2026-07-17 節。build 38 頁＋check-links 零死鏈＋簡繁殘留掃描皆過，**尚未 push**。
